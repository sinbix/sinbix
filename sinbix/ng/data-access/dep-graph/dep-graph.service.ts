...
import { DepGraphQuery } from './dep-graph.query';
import { DepGraphStore } from './dep-graph.store';
import {
  IGraphModel,
  ISearchFilterForm,
} from '@sinbix/sinbix/ng/utils/interfaces';

@Injectable({ providedIn: 'root' })
export class DepGraphService {
  constructor(private store: DepGraphStore, private query: DepGraphQuery) {}
