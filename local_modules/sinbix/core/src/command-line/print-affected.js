...
function printAffected(affectedProjectsWithTargetAndConfig, affectedProjects, projectGraph, sinbixArgs, overrides) {
    const projectNames = affectedProjects.map((p) => p.name);
    const tasksJson = createTasks(affectedProjectsWithTargetAndConfig, projectGraph, sinbixArgs, overrides);
    const result = {
        tasks: tasksJson,
...
function createTasks(affectedProjectsWithTargetAndConfig, projectGraph, sinbixArgs, overrides) {
