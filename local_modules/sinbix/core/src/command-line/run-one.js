...
function runOne(opts) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const reporter = sinbixArgs.withDeps
            ? new ((yield Promise.resolve().then(() => require(`@sinbix/core/src/tasks-runner/run-one-reporter`))).RunOneReporter)(opts.project)
...
function getProjects(projectGraph, includeDeps, project, target) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (includeDeps) {
            const s = yield Promise.resolve().then(() => require(`@sinbix/core/src/project-graph`));
