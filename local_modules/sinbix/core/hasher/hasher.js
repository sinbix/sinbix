...
class Hasher {
    constructor(projectGraph, sinbixJson, options, hashing = undefined) {
        this.projectGraph = projectGraph;
        this.sinbixJson = sinbixJson;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs.length > 0) {
                try {
                    ...
                    throw new Error(`Sinbix failed to execute runtimeCacheInputs defined in sinbix.json failed:\n${e.message}`);
                }
            }
            else {
