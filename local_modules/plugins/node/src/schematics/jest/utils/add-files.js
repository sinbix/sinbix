...
function addFiles(options) {
    ...
    return schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
        schematics_1.applyTemplates(Object.assign(Object.assign({}, options), { offsetFromRoot: plugin_utils_1.offsetFromRoot(projectConfig.root), projectRoot: projectConfig.root, dot: '.' })),
