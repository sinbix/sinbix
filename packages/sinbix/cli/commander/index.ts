...
export async function invokeCommand(
  ...
  switch (command) {
    ...
    case 'generate':
    case 'g':
      return (await import('../src/commander/commands/generate')).generate(
        root,
        commandArgs,
        isVerbose
      );
    case 'run':
    case 'r':
      return (await import('../src/commander/commands/run')).run(
        root,
        commandArgs,
        isVerbose
      );
    case 'migrate':
      return (await import('../src/commander/commands/migrate')).migrate(
        root,
        commandArgs,
        isVerbose
      );
    case 'help':
    case '--help':
      return (await import('../src/commander/commands/help')).help();
    default: {
