...
import { serializeJson } from "@sinbix/devkit/src/workspace/utils/fileutils";
import { addProjectToNxJsonInTree, readJsonInTree } from "@sinbix/devkit/src/workspace/utils/ast-utils";
